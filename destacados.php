...
<head>
  ...
  <link href="Cssn/destacados.css" rel="stylesheet">
  ...
  <section class="main">
    ...
    <div id="videoDiv">
      ...
      <video id="video" autoplay muted loop>
        <source src="imagenes/produccion.mp4" type="video/webm">
      </video>
    ...
    ?>
      <div class="caja1" data-aos="fade-up" data-aos-duration="4000">
        ...
        <a href="art.php?id=<?php echo $mostrar['idArtista'] ?>"> <img class="imagen" src="data:image/jpg;base64,<?php echo base64_encode($mostrar["Foto"]); ?>" alt=""></a>
      </div>
